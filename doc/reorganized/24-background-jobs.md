# 24. Background Jobs y Tareas Programadas

## Índice

[24. Background Jobs y Tareas Programadas](#24-background-jobs-y-tareas-programadas)
  - [24.1. ¿Qué son Background Jobs?](#241-qué-son-background-jobs)
  - [24.2. Arquitectura de Background Jobs](#242-arquitectura-de-background-jobs)
  - [24.3. Implementación del Job de Reporte de Productos](#243-implementación-del-job-de-reporte-de-productos)
  - [24.4. Background Service Orchestrator](#244-background-service-orchestrator)
  - [24.5. Configuración DI con Extension Methods](#245-configuración-di-con-extension-methods)
  - [24.6. Configuración en appsettings.json](#246-configuración-en-appsettingsjson)
  - [24.7. Métodos de Repositorio](#247-métodos-de-repositorio)
  - [24.8. Flujo de Ejecución](#248-flujo-de-ejecución)
  - [24.9. Pruebas Unitarias](#249-pruebas-unitarias)
  - [24.10. Beneficios y Consideraciones](#2410-beneficios-y-consideraciones)
  - [24.11. Comparación con Otras Soluciones](#2411-comparación-con-otras-soluciones)
