# 19. Seguridad HTTP: HSTS, HTTPS y Security Headers

## Índice

[19. Seguridad HTTP](#19-seguridad-http)
  - [19.1. Por Qué HTTPS es Obligatorio](#191-por-qué-https-es-obligatorio)
  - [19.2. HTTP Strict Transport Security (HSTS)](#192-http-strict-transport-security-hsts)
  - [19.3. Redirección HTTP a HTTPS](#193-redirección-http-a-https)
  - [19.4. Security Headers](#194-security-headers)
  - [19.5. Configuración en Desarrollo vs Producción](#195-configuración-en-desarrollo-vs-producción)
  - [19.6. Implementación en Program.cs](#196-implementación-en-programcs)
  - [19.7. Verificación de Seguridad](#197-verificación-de-seguridad)
  - [19.8. Resumen y Buenas Prácticas](#198-resumen-y-buenas-prácticas)
