# 22. File Storage: Almacenamiento de Archivos

## Índice

[22. File Storage: Almacenamiento de Archivos](#22-file-storage-almacenamiento-de-archivos)
  - [22.1. Conceptos Fundamentales de Archivos Estáticos](#221-conceptos-fundamentales-de-archivos-estáticos)
  - [22.2. Configuración de wwwroot en Program.cs](#222-configuración-de-wwwroot-en-programcs)
  - [22.3. UseStaticFiles: Configuración Avanzada](#223-usestaticfiles-configuración-avanzada)
  - [22.4. IStorageService: Interfaz del Proyecto](#224-istorageservice-interfaz-del-proyecto)
  - [22.5. FileSystemStorageService: Implementación](#225-filesystemstorageservice-implementación)
  - [22.6. Controlador de Archivos](#226-controlador-de-archivos)
  - [22.7. Controlador de Productos con Imágenes](#227-controlador-de-productos-con-imágenes)
  - [22.8. Seguridad: Path Traversal](#228-seguridad-path-traversal)
  - [22.9. Configuración de Producción](#229-configuración-de-producción)
