...
namespace TiendaApi.Apis.Services;

/// <summary>
/// Servicio para sembrar datos iniciales en MongoDB.
/// Verifica si hay datos y los crea si no existen.
/// </summary>
public class MongoDbSeedService
{
    private readonly IMongoCollection<Pedido> _pedidosCollection;
    private readonly ILogger<MongoDbSeedService> _logger;

    public MongoDbSeedService(
        IMongoCollection<Pedido> pedidosCollection,
        ILogger<MongoDbSeedService> logger)
    {
